 ...
 * // static ObjectMapper objectMapper = new ObjectMapper(); // ObjectMapper 선언
 * 및 초기화
 * 
 ...
 * 
 * return content.toString(); } private static void printJsonData(String json)
 * throws IOException { ObjectMapper objectMapper = new ObjectMapper(); JsonNode
