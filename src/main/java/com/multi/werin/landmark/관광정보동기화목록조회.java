...
public class 관광정보동기화목록조회 {
    ...
    public static void main(String[] args) {
        try {
            ...
            String apiUrl = "https://apis.data.go.kr/B551011/KorService1/areaBasedSyncList1?"
                    + "MobileOS=ETC&MobileApp=Test&ServiceKey=" + apiKey
...
//        System.out.println("Result Code: " + resultCode);
        ...
        // 전체 JSON 출력
//        System.out.println("Full JSON Response: " + rootNode.toString());
    }
}