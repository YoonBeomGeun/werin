...
@Repository
public class LandmarkInfo1 {
    public StringBuilder jejuinsert(String ko) {
        // API 키를 여기에 추가하세요
        ...
        String apiUrl = "https://apis.data.go.kr/B551011/KorService1/areaCode1?MobileOS=ETC&MobileApp=Test&numOfRows=50&ServiceKey=" + apiKey + "&_type=json";
