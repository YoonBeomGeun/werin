 ...
 * = 1; String info = "detailCommon1"; String index =
 * "&contentTypeId=12&contentId=2858467&MobileOS=ETC&MobileApp=AppTest&defaultYN=Y&firstImageYN=Y&areacodeYN=Y&catcodeYN=Y&addrinfoYN=Y&mapinfoYN=Y&overviewYN=Y";
 * 
 * String apiUrl = "https://apis.data.go.kr/B551011/KorService1/" + info +
 * "?&ServiceKey=" + apiKey + index + "&_type=json&pageNo=" + pageNo +
 * "&numOfRows=" + numOfRows;
 * 
